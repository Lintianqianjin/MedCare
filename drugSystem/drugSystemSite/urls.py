...
from query.views import medic_search, medic_details, interact, illness_medicine

urlpatterns = [
    path('', views.index, name='index'),
    # path('index/',views.index,name = 'index'),
    path('drugsInteraction/', views.goToDrugsInteraction, name='goToDrugsInteraction'),
