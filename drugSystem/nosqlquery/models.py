...
def manually_import_data():
    ...
    ill_medic = open('C:/Users/15473/PycharmProjects/drugSystem/resources/病症_多个药物.csv', 'r', encoding='utf-8').readlines()
    ...
    med_ingr = open('C:/Users/15473/PycharmProjects/drugSystem/resources/药物成分_处理.csv', 'r', encoding='utf-8').readlines()
    medicines = list(map(lambda x: x.name, Medicine.nodes.all()))
    ingredients = []
    for l in med_ingr:
        l = l.replace(r'\ufeff', '')
    ...
    ill_symp = open('C:/Users/15473/PycharmProjects/drugSystem/resources/疾病_症状.csv', 'r', encoding='utf-8').readlines()
    ...
    medic_desc = open('C:/Users/15473/PycharmProjects/drugSystem/resources/治疗.csv', 'r', encoding='utf-8').readlines()
    ...
    interact = open('C:/Users/15473/PycharmProjects/drugSystem/resources/相互关系.csv', 'r', encoding='utf-8').readlines()
    ...
    med_ingr = open('C:/Users/15473/PycharmProjects/drugSystem/resources/药物_包含的抗生素.csv', 'r',
    ...
    interact = open('C:/Users/15473/PycharmProjects/drugSystem/resources/抗生素相互关系.csv', 'r',
                    encoding='utf-8').readlines()
    ingredients = list(map(lambda x: x.name, Ingredient.nodes.all()))
    pairs = []
    for l in interact:
